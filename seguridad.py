...
referencia = "Designación Personal de Seguridad – Ad Interior"
...
draw.text((right_col_x, current_right_y), "Señor@:", fill=text_color, font=font_body_bold) # Negrita
...
paragraphs_to_wrap = [
    # Nota: El saludo se maneja por separado para aplicar negrita solo a 'Estimad@'
